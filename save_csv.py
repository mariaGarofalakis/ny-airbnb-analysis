...
df_attractions.to_csv('df_attractions.csv')
df_count.to_csv('df_count.csv')
df_neigh_price.to_csv('df_neigh_price.csv')
df_neigh_rating.to_csv('df_neigh_rating.csv')
df_neigh_amenities.to_csv('df_neigh_amenities.csv')
df_predictions.to_csv('df_predictions.csv')
df_clust.to_csv('df_clust.csv')
pd.DataFrame(facilities).to_csv('facilities.csv')